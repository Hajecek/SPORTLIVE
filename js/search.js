let users = [
    '<img class="img-fotka hokej-hrac " src="./images/loading-logo/logo.svg"><a href="index.html"><small>Lionel Andrés</small>Messi<span class="info">Pozice: Útočník<img src="./images/loading-logo/logo.svg"></span> </a><div class="pozice"><div class="narodnost">Národnost:<img class="img" src="./images/loading-logo/logo.svg"></div><div class="klub">Tým:<img class="img" src="./images/loading-logo/logo.svg"></div></div>',
